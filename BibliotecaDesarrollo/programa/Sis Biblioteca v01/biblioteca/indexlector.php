...
<?php 
	...
	$texto = " " .$nombre ." " .$apellidos ." | " ."Nro Carnet: " .$carnet;
	...
	<div id="contenedor">
		...
		<div id="ventanalogin">
			...
			<div id="formlogin">
				...
				<div id="cerrar"><a href="javascript:CerrarVentaLogin();">Cerrar</a></div>
				...
				<form method="POST" name="formingreso" id="formcontra">
					<div id="formdatos">
						<input type="password" id="txtclave" placeholder="Contraseña Antigua" required>
		...
		<center>
			...
			<ul id="menu">
				...
				<li><a onclick="VistaReserva();">Pedir Libro</a></li>
				<li><a>Actividad</a> 
					<ul>
						<li><a onclick="VistaLibrosReservados();">Lista de Pedidos</a></li>
