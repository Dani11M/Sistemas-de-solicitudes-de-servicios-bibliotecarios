...
<html>
<head>
	<link rel="stylesheet" type="text/css" href="css_l/hoja_NueBibliotecario1.css">
	<meta charset="utf-8">
	<title></title>
</head>
<body>
	...
	<div id="CModBi">
		...
		<div id="formulario">
			...
			<div id="GeneradorPadre">
				...
				<input type="text" required id="txtnroCarnet" value="" pattern=".{8,}" maxlength="8">	
			</div>
