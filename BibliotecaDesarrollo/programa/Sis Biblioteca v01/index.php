...
<head>
	...
	<link rel="stylesheet" href="css/hoja_index1.css">
...
<body onload="VistaInicio()">
	<div id="contenedor">
		...
		<div id="ventanalogin">
			...
			<div id="formlogin">
				...
				<form method="POST" name="formingreso">
					...
					<button type="submit" name="btnEntrar">Continuar</button>
		...
		<header>
			...
			<div id="titulo">
				<h1>BIBLIOLOGY - DESARROLLO WEB</h1>
			</div>	

			<div id="banner">
				<div><img src="biblioteca/img_l/img5.jpg" width="900" height="200"></div>	
			</div>
